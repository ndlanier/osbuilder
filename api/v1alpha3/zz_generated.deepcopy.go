...
func (in *CPU_MEM) DeepCopyInto(out *CPU_MEM) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CPU_MEM.
func (in *CPU_MEM) DeepCopy() *CPU_MEM {
	if in == nil {
		return nil
	}
	out := new(CPU_MEM)
